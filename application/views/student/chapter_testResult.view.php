                      ...
                      <table class="table table-borderless">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php if (!empty($resultDetail)){
                              if (!empty($chapterTest_detail)) {
                                $difference = $chapterTest_detail['no_of_questions']-count($resultDetail); 
                                echo $difference; 
                              }
                            } ?></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><?php if(!empty($result)){ if($result['correct_ans']/$chapterTest_detail['no_of_questions']*100 >=50) {echo "Pass";}else{echo "Fail";}} ?></td>
                          </tr>
                          <tr>
                            <th scope="row">Performance</th>
                            <td><?php if(!empty($result)){ if($result['correct_ans']/$chapterTest_detail['no_of_questions']*100 >=75) {echo "Good";}elseif($result['correct_ans']/$chapterTest_detail['no_of_questions']*100 >=50){echo "Average";}else{echo "Poor";}} ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
