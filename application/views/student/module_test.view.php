...
$no_of_questions = (!empty($exam_details)) ? $exam_details['no_of_questions'] : $defaultChapterSettings['no_of_questions'];
$test_time = (!empty($exam_details)) ? $exam_details['test_time'] : $defaultChapterSettings['test_time'];
$per_question_marks = (!empty($exam_details)) ? $exam_details['question_marks'] : $defaultChapterSettings['question_marks'];
...
<body class="vertical-layout student-panel-body vertical-content-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-content-menu" data-col="2-columns">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="heading chapter-name" style="text-align: center; display: none;">
                  <h4><strong><?php if(!empty($exam_questions)) { echo $exam_questions['course_title'];} ?></strong></h4>
                </div>
              </div>
              <div class="col-sm-4">
                      ...
                      <div class="card-group">
                          <div class="card card-default">
                              ...
                              <div class="card-collapse">
                                  <div class="card-body">
                                      <!-- <ul id="atmpt"><li><a style="text-decoration: none !important;" href="#ques0">Ques 1</a></li></ul> -->
                                  </div>
                              </div>
                          </div>
                      </div>
              ...
              <div class="tab-content px-1 pt-1 col-md-9">
                <div class="w3-padding w3-light-grey" id="question_one" style="margin-left: 40px; display: none;">
                  <?php if(!empty($exam_questions)) { ?>
                    ...
                    <p class="w3-large" style="margin-bottom:25px;"><h4 style="margin-bottom:2.0rem;"><b id="ques_no">Ques 1</b>: <?php  echo $exam_questions['question_title']; ?></h4></p>
                  ...
                  <div class="col-md-offset-12">
                    <button type="button" class="btn btn-outline-primary round btn-min-width mr-1 mb-1 pull-right" id="submit_ques">Next <i class="ft-arrow-right"></i></button> 
                    <button type="button" class="btn btn-outline-primary round btn-min-width mr-1 mb-1 pull-right" id="submit_exm" style="display: none;">Submit Exam </button>
                  </div>
                  <?php echo form_close(); } ?>
                </div>
  ...
  <script src="<?php echo base_url()?>/app-assets/js/final_exam.js" type="text/javascript"></script>
</body>
</html>