                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"><?php if (!empty($TotalBought_module)) { echo $TotalBought_module; } else{echo 0;}  ?></h3>
                      <h6>Total Bought Modules</h6>
                    </div>
                    <div>
            ...
            <div class="card pull-up">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="warning"><?php echo $completed_modules; ?></h3>
                      <h6>Total Completed Modules</h6>
                    </div>
                    <div>
            ...
            <div class="card pull-up">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="success"><?php echo (!empty($totalExams)) ? count($totalExams) : '0' ; ?></h3>
                      <h6>Total Exams</h6>
                    </div>
                    <div>
                    ...
                    <?php foreach ($allBanners as $key=>$banner) 
                        { ?>
                          <div class="carousel-item <?php echo ($key == 0) ? "active" : ""; ?>">
                            <img src="<?php echo $banner['banner_image']; ?>" class="d-block w-100" alt="<?php echo $banner['alt_text']; ?>">
                          </div>
                        <?php
                      }
                    ?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Student Activity forum</h4>
              </div>
              <div class="card-content">
                  ...
                  <table id="recent-orders" class="table table-hover table-xl mb-0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><small><?php echo $single_activity['time'];?> ago</small></td>
                      </tr>
                    <?php } }?>
                    </tbody>
                  </table>
