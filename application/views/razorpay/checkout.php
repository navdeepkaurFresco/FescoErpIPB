...
<?php
$productinfo = $itemInfo['course_title'];
$txnid = time();
$surl = $surl;
$furl = $furl;        
$key_id = RAZOR_KEY_ID;
...
$card_holder_name = 'IPB Team';
$email = 'simmisskmedia@gmail.com';
$phone = '9779545598';
    ...
    <div class="row">   
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                        
            <table class="table table-bordered table-hover table-striped print-table order-table" style="font-size:11px;">
                ...
                <tbody>                    
                    <tr>
                        <td class="text-left"><img width="80" height="80" src="<?php print $itemInfo['course_image'];?>"></td>
                        <td class="text-left"><?php print $itemInfo['course_title'];?></td>
                        <td class="text-left"><?php print $itemInfo['fee'];?></td>
                        <td class="text-right">1</td>
                        <td class="text-right"><?php print $itemInfo['fee'];?></td>                        
                    </tr>                        
                </tbody>                        
            </table>
        </div>
