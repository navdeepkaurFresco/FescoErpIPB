  ...
  <div class="navbar-wrapper">
    <div class="navbar-header">
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="<?php echo base_url('/instructor/home'); ?>">
            <img class="brand-logo" alt="modern admin logo" src="<?php echo base_url(); ?>/app-assets/images/IPBLogo.png">
            <h3 class="brand-text">IPB Instructor Panel</h3>
          </a>
        </li>
      ...
      <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right">
          <li class="dropdown dropdown-user nav-item">
            ...
            <img src="<?php echo base_url('uploads/').$this->session->userdata('profile_image'); ?>" alt="avatar"><i></i></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item" href="<?php echo site_url('instructor/account'); ?>"><i class="ft-user"></i> Edit Profile</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="<?php echo base_url('instructor/logout'); ?>"><i class="ft-power"></i> Logout</a>
            </div>
          </li>
        </ul>
      </div>
